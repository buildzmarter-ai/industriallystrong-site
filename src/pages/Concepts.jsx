export default function Concepts() {
  return (
    <div>
      <h1>Concepts</h1>
      <p>
        IndustriallyStrong develops technical concepts intended for institutions
        capable of executing at meaningful scale.
      </p>
      ...
      <section style={{ marginTop: "40px" }}>
        ...
        <p>
          The site is intended to connect concept formation with real evidence:
          deployed systems, research engines, and architectural experiments that
          show the direction is grounded in actual implementation capability.
        </p>
      </section>
    </div>
  );
