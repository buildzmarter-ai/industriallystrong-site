        ...
        <section id="featured-labs">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 14 }}>
            {[
              ...
              { href: "/lab/vdw-cavity.html", title: "vdW Intracavity Optical Control", desc: "Seven-layer van der Waals cavity with phase, amplitude, and polarization modulation at DUV wavelengths. Simulation-backed; evidence-classified.", color: T.green, posture: "simulated" },
        ...
        <section id="all-labs">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: 12 }}>
            {[
              ...
              { href: "https://replica-race-lab.industriallystrong.com/", title: "Replica Race Resolution", desc: "Same events, different arrival order: last-write-wins commits the wrong book with a hedge breach; parallel persistence holds both branches until arbitration. Every headline number asserted by the lab's own test.", domain: "Distributed" },
              ...
              { href: "/lab/vdw-cavity.html", title: "vdW Intracavity Optical Control", desc: "Seven-layer vdW cavity providing phase, amplitude, and polarization control at DUV wavelengths. Simulation-backed. REPO / DERIVED / PROXY classified.", domain: "Optics" },
            ].map(card => (
