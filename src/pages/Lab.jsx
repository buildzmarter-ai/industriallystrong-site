        ...
        <section id="all-labs">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: 12 }}>
            {[
              ...
              { href: "/lab/replica-race.html", title: "Replica Race Resolution", desc: "Same events, different arrival order: last-write-wins commits the wrong book with a hedge breach; parallel persistence holds both branches until arbitration. Every headline number asserted by the lab's own test.", domain: "Distributed" },
